          ...
          <div class="row">
			<div class="col-md-12 col-xs-12">
				<?php 
					...
					$txtKodeProduk = !empty($txtKodeProduk)? $txtKodeProduk: $produk->kode_produk;
					$txtIdKategori = !empty($txtIdKategori)? $txtIdKategori: $produk->id_kategori;
					$txtNamaProduk = !empty($txtNamaProduk)? $txtNamaProduk: $produk->nama_produk;
					$txtMerkProduk = !empty($txtMerkProduk)? $txtMerkProduk: $produk->id_merk;
					$txtDeskripsiProduk = !empty($txtDeskripsiProduk)? $txtDeskripsiProduk: $produk->deskripsi_produk;
					$txtDiskonProduk = !empty($txtDiskonProduk)? $txtDiskonProduk: $produk->diskon_produk;
					$txtStokProduk = !empty($txtStokProduk)? $txtStokProduk: $produk->stok_produk;
					$txtHargaProduk = !empty($txtHargaProduk)? $txtHargaProduk: $produk->harga_produk;
					$txtStatusProduk = !empty($txtStatusProduk)? $txtStatusProduk: $produk->status_produk;
					if(!empty($status)):
				?>
				...
				<div class="panel panel-success">
    				...
    				<?php echo form_open('admin.php/produk/update-produk', "class='form'") ?>
