          ...
          <div class="row">
			<div class="col-md-12 col-xs-12">
				<?php 
					...
					$txtIdKabupaten = !empty($txtIdKabupaten)? $txtIdKabupaten: $kabupaten->id_kabupaten;
					$txtIdProvinsi = !empty($txtIdProvinsi)? $txtIdProvinsi: $kabupaten->id_provinsi;
					$txtNamaKabupaten = !empty($txtNamaKabupaten)? $txtNamaKabupaten: $kabupaten->nama_kabupaten;
					if(!empty($status)):
				?>
				...
				<div class="panel panel-success">
    				...
    				<?php echo form_open('admin.php/kabupaten/update-kabupaten', "class='form'") ?>
					<div class="panel-body">
						<div class="form-group">
							...
							?>
								<option value="<?php echo $provinsi->id_provinsi ?>" <?php echo($provinsi->id_provinsi==$kabupaten->id_provinsi? "selected":"") ?>><?php echo $provinsi->nama_provinsi ?></option>
							<?php 
								endforeach
							?>
							</select>
