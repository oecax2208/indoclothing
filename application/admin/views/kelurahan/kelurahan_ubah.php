          ...
          <div class="row">
			<div class="col-md-12 col-xs-12">
				<?php 
					...
					$txtIdKelurahan = !empty($txtIdKelurahan)? $txtIdKelurahan: $kelurahan->id_kelurahan;
					...
					$txtNamaKelurahan = !empty($txtNamaKelurahan)? $txtNamaKelurahan: $kelurahan->nama_kelurahan;
					$txtKodePos = !empty($txtKodePos)? $txtKodePos: $kelurahan->kode_pos;
				...
				<div class="panel panel-success">
    				...
    				<?php echo form_open('admin.php/kelurahan/update-kelurahan', "class='form'") ?>
