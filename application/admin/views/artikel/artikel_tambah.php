			...
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<?php
						...
						$txtJudulArtikel = !empty($txtJudulArtikel)? $txtJudulArtikel: "";
						$txtIsiArtikel = !empty($txtIsiArtikel)? $txtIsiArtikel: "";
						$txtIsiSingkat = !empty($txtIsiArtikel)? $txtIsiArtikel: "";
						$txtStatusTampil = !empty($txtStatusTampil)? $txtStatusTampil: "";
						if(!empty($status)):
					?>
					...
					<div class="panel panel-success">
						...
						<?php echo form_open_multipart('admin.php/artikel/simpan-artikel', "class='form'") ?>
