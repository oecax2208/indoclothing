          ...
          <div class="row">
			<div class="col-md-12 col-xs-12">
				<?php 
					...
					$txtIdProvinsi = !empty($txtIdProvinsi)? $txtIdProvinsi: $kecamatan->id_provinsi;
					$txtIdKecamatan = !empty($txtIdKecamatan)? $txtIdKecamatan: $kecamatan->id_kecamatan;
					$txtIdKabupaten = !empty($txtIdKabupaten)? $txtIdKabupaten: $kecamatan->id_kabupaten;
					$txtNamaKecamatan = !empty($txtNamaKecamatan)? $txtNamaKecamatan: $kecamatan->nama_kecamatan;
